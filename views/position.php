...
<title>Asaeli Matelau: PS3 - Position Description </title> 
  ...
  <div class="row-fluid">  
         ...
         <!--Sidebar content-->  
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="position-sought.php">Position Sought</a></li>
    ...
    <div class="span8"> 
      ...
      <form class="form-horizontal" method="post" action="">
        <h3>Description of Job Desired</h3>
        <!--Check for Errors -->
        <?php sticky('error1') ?>
        <div class="control-group">
          <div class="controls">
            <textarea name="position" placeholder="I would like..." rows="4"><?php sticky('position') ?></textarea>
          </div>
        </div>
